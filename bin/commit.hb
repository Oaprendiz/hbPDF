 ...
 *
 * Alterado por Oaprendiz (jorgenunes5+prog gmail.com) para
 * utilização em hbPDF
 *
...
FUNCTION hbshell_ProgName()
   RETURN hb_UTF8ToStr( hb_ProgName() )
...
FUNCTION hb_LeftEq(cArg1, cArg2)
return left(cArg1, len(cArg2)) == cArg2

FUNCTION hb_StrIsUTF8()//(cArg)
return .t.
